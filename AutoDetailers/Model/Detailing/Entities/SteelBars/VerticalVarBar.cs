...
namespace Model.Detailing.Entities.SteelBars
{
    class VerticalVarBar : VariableDistribuction
    {
        ...
        public double MediumLength { get; private set; }
        ...
        private void AddDimensions(Polyline polyline)
        {
            ...
            if (BarDir == 1)
            {
                ...
                AddDimension(dimName, pack[2], pack[3], offset, 0, "VAR"/*GetDimensionStringY(2, pack)*/);
            ...
            else
            {
                ...
                AddDimension(dimName, pack[1], pack[2], 0, 0, GetDimensionStringX(1, pack));
                AddDimension(dimName, pack[2], pack[3], 0, 0, "VAR"/*GetDimensionStringY(2, pack)*/);
                AddDimension(dimName, pack[3], pack[4], 0, -offset, GetDimensionStringX(3, pack));
