...
namespace Structures.WellDetailer.Entities
{
    public class CircularWall
    {
        ...
        public void DrawWallUpperView(Point3d upperViewCenter)
        {
            ...
            Utilities.DrawingShapes.DrawCircle(upperViewCenter, InternalDiameter, insideLayer); //InsideWall colocar tracejado
        ...
        private double InferiorAmount(Misla misla, double position)
        {
            ...
            {
                return (misla.Heigth / misla.Length) * (LeftMislaPosition - position);
            }
        }
