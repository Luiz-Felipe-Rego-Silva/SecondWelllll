...
namespace Detailing.Entities
{
    ...
    {
        public static void DrawAACutSign(Point3d centerPoint, double extension)
        {
        ...
        public static void DrawBBCutSign(Point3d centerPoint, double extension)
        {
        ...
        {
            DrawBBCutSign(centerPoint, extension);
            DrawAACutSign(centerPoint, extension);
        }
    }
}
